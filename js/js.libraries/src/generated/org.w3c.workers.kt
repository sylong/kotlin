...
public external open class ServiceWorkerMessageEvent(type: String, eventInitDict: ServiceWorkerMessageEventInit = noImpl /* noImpl */) : Event {
    open val data: Any?
...
public external open class ExtendableEvent(type: String, eventInitDict: ExtendableEventInit = noImpl /* noImpl */) : Event {
...
public external open class InstallEvent(type: String, eventInitDict: ExtendableEventInit = noImpl /* noImpl */) : ExtendableEvent {
...
public external open class ExtendableMessageEvent(type: String, eventInitDict: ExtendableMessageEventInit = noImpl /* noImpl */) : ExtendableEvent {
    open val data: Any?
    open val origin: String
    open val lastEventId: String
