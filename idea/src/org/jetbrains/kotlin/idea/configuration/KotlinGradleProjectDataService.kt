...
interface GradleProjectImportHandler {
    ...
    operator fun invoke(facet: KotlinFacet, projectData: ProjectData?, sourceSetData: GradleSourceSetData)
}
...
class KotlinGradleProjectDataService : AbstractProjectDataService<GradleSourceSetData, Void>() {
    ...
    override fun postProcess(
        ...
        for (sourceSetNode in toImport) {
            ...
            GradleProjectImportHandler.getInstances(project).forEach { it(kotlinFacet, projectData, sourceSetData) }
        }
    }
}