...
public external open class TrackEvent(type: String, eventInitDict: TrackEventInit = noImpl /* noImpl */) : Event {
...
public external open class RelatedEvent(type: String, eventInitDict: RelatedEventInit = noImpl /* noImpl */) : Event {
...
public external open class Path2D() : CanvasPath {
    ...
    constructor(paths: Array<Path2D>, fillRule: String = noImpl /* "nonzero" */)
...
public external open class DragEvent(type: String, eventInitDict: DragEventInit = noImpl /* noImpl */) : MouseEvent {
...
public external open class PopStateEvent(type: String, eventInitDict: PopStateEventInit = noImpl /* noImpl */) : Event {
    open val state: Any?
}
...
public external open class HashChangeEvent(type: String, eventInitDict: HashChangeEventInit = noImpl /* noImpl */) : Event {
...
public external open class PageTransitionEvent(type: String, eventInitDict: PageTransitionEventInit = noImpl /* noImpl */) : Event {
...
public external open class ErrorEvent(type: String, eventInitDict: ErrorEventInit = noImpl /* noImpl */) : Event {
...
public external open class MessageEvent(type: String, eventInitDict: MessageEventInit = noImpl /* noImpl */) : Event {
    open val data: Any?
    open val origin: String
...
public external open class CloseEvent(type: String, eventInitDict: CloseEventInit = noImpl /* noImpl */) : Event {
...
public external open class StorageEvent(type: String, eventInitDict: StorageEventInit = noImpl /* noImpl */) : Event {
    open val key: String?
...
public external open class CustomEvent(type: String, eventInitDict: CustomEventInit = noImpl /* noImpl */) : Event {
    open val detail: Any?
...
public external open class DOMPoint : DOMPointReadOnly {
    ...
    constructor(x: Double = noImpl /* 0.0 */, y: Double = noImpl /* 0.0 */, z: Double = noImpl /* 0.0 */, w: Double = noImpl /* 1.0 */)
...
public external open class DOMRect(x: Double = noImpl /* 0.0 */, y: Double = noImpl /* 0.0 */, width: Double = noImpl /* 0.0 */, height: Double = noImpl /* 0.0 */) : DOMRectReadOnly {
    override var x: Double
    override var y: Double
...
public external open class MediaQueryListEvent(type: String, eventInitDict: MediaQueryListEventInit = noImpl /* noImpl */) : Event {
    open val media: String
    open val matches: Boolean
}
