...
public class ExpressionCodegen extends KtVisitor<StackValue, StackValue> implements LocalLookup {
    ...
    private final Type suspendFunctionReturnType;
    ...
    public ExpressionCodegen(
        ...
        if (originalSuspendDescriptor != null && originalSuspendDescriptor.getReturnType() != null) {
            ...
            suspendFunctionReturnType = typeMapper.mapReturnType(originalSuspendDescriptor);
        }
        else {
            this.returnType = returnType;
            suspendFunctionReturnType = null;
        }
    ...
    private static FunctionDescriptor getOriginalSuspendDescriptor(MethodContext context) {
        ...
        if (context.getFunctionDescriptor().isSuspend()) return unwrapInitialSignatureDescriptor(context.getFunctionDescriptor());
    ...
    public void returnExpression(KtExpression expr) {
        ...
        boolean isVoidSuspendFunction = suspendFunctionReturnType != null && suspendFunctionReturnType.getSort() == Type.VOID;
        // If generating body for named block-bodied function or Unit-typed suspend function, generate it as sequence of statements
        Type typeForExpression =
                isBlockedNamedFunction || isVoidSuspendFunction
                ? Type.VOID_TYPE
                : returnType;
